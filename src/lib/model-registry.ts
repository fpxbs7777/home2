...
const RAPIDEZ: AgentModel[] = [
  {
    ...
    skills: ["instruccion-rapida", "redaccion", "herramientas"],
  ...
  },
  {
    ...
    skills: ["instruccion-rapida", "chat", "herramientas"],
    enableThinking: false,
    puedePlanear: false,
    maxTokens: 2048,
  },
  {
    ...
    skills: ["instruccion-rapida", "razonamiento-ligero"],
    enableThinking: false,
    puedePlanear: false,
    maxTokens: 2048,
  },
  ...
  },
  {
    ...
    skills: ["instruccion-rapida", "chat"],
    enableThinking: false,
    puedePlanear: false,
    maxTokens: 1024,
  },
...
const RAZONAMIENTO: AgentModel[] = [
  {
    ...
    skills: ["razonamiento-profundo", "analisis-dcf", "portfolio", "planificacion", "herramientas"],
    enableThinking: true,
  ...
  },
  {
    ...
    skills: ["razonamiento-profundo", "analisis-dcf", "planificacion", "herramientas"],
    enableThinking: true,
  ...
  },
  {
    ...
    skills: ["razonamiento-profundo", "analisis-dcf", "portfolio"],
    enableThinking: true,
    reasoningBudget: 12288,
    puedePlanear: true,
    maxTokens: 8192,
  },
  {
    ...
    skills: ["razonamiento-profundo", "analisis-dcf"],
    enableThinking: true,
  ...
  },
  {
    ...
    skills: ["razonamiento-profundo", "planificacion", "herramientas"],
    enableThinking: true,
    reasoningBudget: 8192,
    puedePlanear: true,
    maxTokens: 6144,
  },
  {
    ...
    skills: ["razonamiento-profundo", "analisis-dcf", "portfolio", "chat"],
    enableThinking: true,
    reasoningBudget: 8192,
    puedePlanear: true,
    maxTokens: 6144,
  },
  {
    ...
    skills: ["razonamiento-profundo", "analisis-dcf", "chat"],
    enableThinking: true,
    reasoningBudget: 8192,
    puedePlanear: true,
    maxTokens: 6144,
  },
  {
    ...
    skills: ["razonamiento-profundo", "herramientas", "planificacion"],
    enableThinking: true,
    reasoningBudget: 8192,
    puedePlanear: true,
    maxTokens: 6144,
  },
  {
    ...
    skills: ["razonamiento-profundo", "herramientas"],
    enableThinking: true,
    reasoningBudget: 8192,
    puedePlanear: true,
    maxTokens: 6144,
  },
  {
    ...
    skills: ["razonamiento-profundo", "planificacion"],
    enableThinking: true,
    reasoningBudget: 8192,
    puedePlanear: true,
    maxTokens: 8192,
